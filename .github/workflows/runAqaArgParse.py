...
def main():
    ...
    parser.add_argument('--sdk_resource', default=['nightly'], choices=['nightly', 'releases', 'customized', 'build_jdk', 'build_openj9'], nargs='+')
    ...
    parser.add_argument('--tkg_repo', default=na, nargs='+')
    parser.add_argument('--tkg_ref', default=na, nargs='+')
